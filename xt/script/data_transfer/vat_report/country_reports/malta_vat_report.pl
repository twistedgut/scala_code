...
foreach my $channel_id ( sort {$a <=> $b} keys %channels ) {
    ...
    open (my $CSV,'>','/opt/xt/deploy/xtracker/script/data_transfer/vat_report/output/'.$channels{$channel_id}.'_malta_report.csv') || warn "Cannot open csv output file: $!";
    ...
    $pdf->to_file('/opt/xt/deploy/xtracker/script/data_transfer/vat_report/output/'.$channels{$channel_id}.'_Malta_Invoice.pdf') || die("Unable to create file");
    ...
    $pdf->to_file('/opt/xt/deploy/xtracker/script/data_transfer/vat_report/output/'.$channels{$channel_id}.'_Malta_Credit_Note.pdf') || die("Unable to create file");
}
