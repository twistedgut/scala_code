...
from variant v 
left join quantity q on v.id = q.variant_id and q.channel_id = 1
...
open my $fh, ">", "/var/data/xt_static/utilities/data_transfer/maxisun/intl/csv/MAINSTOCK.csv" || die "Couldn't open file: $!";
