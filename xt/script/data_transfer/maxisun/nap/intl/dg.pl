...
supplier sup, shipping_attribute sa, link_delivery__stock_order ld_so
where ld.date between ? and ?
...
d.designer, s.season, sa.legacy_countryoforigin, po.purchase_order_number,
...
open my $fh, ">", "/var/data/xt_static/utilities/data_transfer/maxisun/intl/csv/dg.csv" || die "Couldn't open file: $!";
