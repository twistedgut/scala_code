...
p.legacy_sku, p.designer_id, p.season_id, oa.country, ri.return_type_id,
...
open my $fh1, ">",
"/var/data/xt_static/utilities/data_transfer/maxisun/intl/csv/sgr-ex.csv" || die "Couldn't open file: $!";
open my $fh2, ">",
"/var/data/xt_static/utilities/data_transfer/maxisun/intl/csv/sgr-re.csv" || die
"Couldn't open file: $!";
open my $fh3, ">",
"/var/data/xt_static/utilities/data_transfer/maxisun/intl/csv/sgr-sc.csv" || die
"Couldn't open file: $!";
...
$qry = "select ri.id, cp.psp_ref as basket_nr, o.basket_nr as old_basket, o.order_nr, s.return_airway_bill,
p.legacy_sku, p.designer_id, p.season_id, oa.country,
