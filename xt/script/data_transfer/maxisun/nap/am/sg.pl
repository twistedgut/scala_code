...
oa.country, oa.county, to_char(sisl.date, 'DDMMYYYY') as dispatch_date, c.currency 
...
open my $fh, ">",
"/var/data/xt_static/utilities/data_transfer/maxisun/am/csv/sg.csv" || die "Couldn't open file: $!";
