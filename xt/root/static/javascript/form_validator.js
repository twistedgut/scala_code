...
//	var address_elements = new Array("address_line_1","address_line_2","address_line_3","towncity","county","postcode","country");

//	for (i=0; i<address_elements.length; i++)
//		{	
//			var shipping_element = 'document.all.shipping_' + address_elements[i] + '.value';
	//		var billing_value = eval ('document.all.billing_' + address_elements[i] + '.value');
//
//			shipping_element = 'billing_value'; 
//
//		}
	
		document.all.shipping_address_line_1.value = eval ('document.all.billing_address_line_1.value');
		document.all.shipping_address_line_2.value = eval ('document.all.billing_address_line_2.value');
		document.all.shipping_address_line_3.value = eval ('document.all.billing_address_line_3.value');
		document.all.shipping_towncity.value = eval ('document.all.billing_towncity.value');
		document.all.shipping_county.value = eval ('document.all.billing_county.value');
		document.all.shipping_postcode.value = eval ('document.all.billing_postcode.value');
		document.all.shipping_country.value = eval ('document.all.billing_country.value');
...
function popup_add_comment (customer_number,order_number) {

	var new_window = window.open('blank.html','addComentView','toolbar=no,width=425,height=400,directories=no,status=no,scrollbars=yes,resize=no,menubar=no');
	// populate fields
