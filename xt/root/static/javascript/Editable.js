...
(function () {
    YAHOO.widget.EditableElement = function() {
        ...
        this.clear_input = function() {
            if (this.input) {
                ...
                if (this.contents_new != this.contents) {
                    var triggerEl = this.step_up(this.clicked);
                    this.callback(triggerEl);
                }
                else {
               //     YAHOO.log('contents unchanged - not worth submitting');
                }
            }
            this.clicked  = undefined;
            this.contents = undefined;
        ...
        this.check = function(ev) {
             //   YAHOO.log('called: this.check()');
                if (!ev) {
                    if (this.clicked == undefined) {
                     //   YAHOO.log('TRUE');
                        return true;
                    }
                    //YAHOO.log('check(): no ev detected');
                    //YAHOO.log('check() this.clicked: ', this.clicked);
                    //YAHOO.log('FALSE');
                    return false;
                }
            if (this.clicked) {
                clicked = YU.Event.getTarget(ev);
                //YAHOO.log('check() clicked: ', clicked);
                this.clear_input();
                //YAHOO.log('TRUE');
                return true;
            }
