...
Tests the contents of the Pre-Order Payment page, URI:
...
Test::XTracker::Client::SelfTest->new(
    content    => (join '', (<DATA>)),
    uri        => '/StockControl/Reservation/PreOrder/Payment',
    expected   => {
        payment_total => '560.52 GBP',
        payment_total_discount => 'includes a 15.00% discount',
    }
);
...
<html lang="en">
    <head>
        ...
        <!-- (end) YUI majik -->
            ...
            <script type="text/javascript" src="/javascript/xui.js"></script>

            <script type="text/javascript" src="/javascript/preorder/preorder-payment.js"></script>
        ...
        <!-- Custom CSS -->
            ...
            <link rel="stylesheet" type="text/css" href="/css/preorder/preorder-payment.css">
    ...
    <div id="content">
        ...
        <div id="contentRight" >
                    ...
                    <div id="pageTitle">
                        ...
                        <h5>&bull;</h5><h3>Pre Order Payment</h3>
                    </div>
...
<div id="payment__page_grid">
    ...
    <div class="payment__page_column">
        <h3 class="title-NAP">Previously Used Cards</h3>
    ...
    <div class="payment__page_column">
        <div class="payment__page_cell">
            <h3 class="title-NAP">Credit/Debit Card</h3>
        ...
        <div class="payment__page_cell">
            <h3 class="title-NAP">Payment Due</h3>
            <span id="payment__total_due">560.52 GBP</span>


                    <span id="payment__total_due__discount"> includes a 15.00% discount</span>
    ...
    <form id="payment__cancel_button_form" action="Basket" method="post">
        ...
        <input type="hidden" id="payment__pre_order_id" name="pre_order_id" value="125">
    </form>


        <form id="payment__payment_form" name="payment__payment_form" method="POST" action="https://localhost:8443/psp/payment">
            <input type="hidden" name="paymentSessionId" value="" />
            <input type="hidden" name="redirectUrl"      value="http://10.5.16.161:8529/StockControl/Reservation/PreOrder/Payment?shipment_option_id=7&org_telephone_day=&org_telephone_eve=&pre_order_id=125&payment_session_id=" />
            <input type="hidden" name="customerId"       value="31" />
            <input type="hidden" name="site"             value="nap_intl" />
