...
CustomerCare_CustomerCategory.t
...
Test::XTracker::Client::SelfTest->new(
    content    => (join '', (<DATA>)),
    uri        => '/CustomerCare/CustomerCategory',
    expected   => {
            success => [
                {
                    'Customer Number' => '14',
                    'Email Address'  => 'cv-test-486@net-a-porter.com',
                    Name => 'Test First Name 829 Test Last Name 339'
                },
                {
                    'Customer Number' => '23',
                    'Email Address'  => 'perl@net-a-porter.com',
...
<html lang="en">
    <head>
        ...
        <title>Customer Category &#8226; Customer Care &#8226; XT-DC1</title>
        ...
        <!-- (end) YUI majik -->
            ...
            <script type="text/javascript" src="/javascript/customercare/bulkcustomercategorysummary.js"></script>
        ...
        <!-- Custom CSS -->
            ...
            <link rel="stylesheet" type="text/css" href="/css/customercare/customercategory.css">
    ...
    <div id="headerTop">
        ...
        <div id="headerControls">
                ...
                <span class="operator_name">Logged in as: Emma Howson</span>
...
<div id="nav1" class="yuimenubar yuimenubarnav">
    ...
    <div id="content">
        ...
        <div id="contentRight" >
                    ...
                    <div id="pageTitle">
                        <h1>Customer Care</h1>
                        <h5>&bull;</h5><h2>Customer Category</h2>
  ...
  <ul class="breadcrumb">
                    ...
                    <!-- BEGIN root/base/customercare/customercategory/summary.tt -->
<div id="successful" class="results">
    <h3>Successful category updates</h3>

    <div id="success_count" class="total">
        Total successful customer numbers: 0
    </div>

 <div id="success_table">
        <table id="tbl_category_success" class="data wide-data divided-data">
        <tr>
            <td class="customerid tableHeader">Customer Number</th>
            <td class="customerid tableHeader">Name</th>
            <td class="customerid tableHeader">Email Address</th>
        </tr>

        <tr>
            <td class="customerid dividebelow">14</td>
             <td class="customerid dividebelow">Test First Name 829 Test Last Name 339</td>
            <td class="customerid dividebelow">cv-test-486@net-a-porter.com</td>
        </tr>

        <tr>
            <td class="customerid dividebelow">23</td>
            <td class="customerid dividebelow">Test-forename Test-surname</td>
            <td class="customerid dividebelow">perl@net-a-porter.com</td>
        </tr>
        </table>
    </div>
...
<div id="unsuccessful" class="feedback">
    <h3>Failed category updates</h3>

    <div id="failure_count" class="total">
        Total failed customer numbers: 2
    </div>



    <div id="failure_table">
        <table id="tbl_category_failure" class="data wide-data divided-data">

            <tr>
                <td class="customerid tableHeader">Failed Numbers</td>
            </tr>


            <tr>
                <td class="customerid dividebelow">1067</td>
            </tr>
            <tr>
                <td class="customerid dividebelow">1068</td>
            </tr>
        </table>
    </div>

    <form  name="retry_form" id="data_form"  method="post" action="http://xtdc1-ehowson.net-a-porter.com:8529/CustomerCare/CustomerCategory">
        <input type="hidden" id="failed_customer_ids" name="failed_customer_ids" value="1067, 1068"/>
        <input type="submit" name="retry" id="retry" class="button" value="Retry"/>
    </form>
</div>

<!-- END root/base/customercare/customercategory/summary.tt -->
    ...
    <p id="footer">    xTracker-DC  (2014.06.00.35.g7d0190d / IWS phase 2 / PRL phase 0 / ). &copy; 2006 - 2014 NET-A-PORTER
