...
Test::XTracker::Client::SelfTest->new(
    content    => (join '', (<DATA>)),
    spec       => 'StockControl/Recode',
    expected   => {
        source => [
            {
                'Size' => '33L',
                'Destroy Quantity' => {
                    'input_name' => 'destroyquantity-12-864',
                    'value' => '',
                    'input_value' => '0'
                },
                'Designer' => 'designer',
                ...
                'SKU' => {
                    'value' => '12-864',
                    'url' => '/StockControl/Inventory/Overview?variant_id=29'
                }
            },
            {
                'Size' => '33L',
                'Destroy Quantity' => {
                    'input_name' => 'destroyquantity-13-864',
                    'value' => '',
                    'input_value' => '0'
                },
                'Designer' => 'designer',
                ...
                'SKU' => {
                    'value' => '13-864',
                    'url' => '/StockControl/Inventory/Overview?variant_id=32'
                }
            }
        ],
    },
...
<html lang="en">
    <head>
        ...
        <title>Recode &#8226; Stock Control &#8226; XT-DC1</title>
    ...
    <div id="tabContainer" class="yui-navset">
        ...
        <tr>
            ...
            <td width="5%" align="right" nowrap>
                <ul class="yui-nav">						<li class="selected"><a href="#tab1" class="contentTab-NAP" style="text-decoration: none;"><em>NET-A-PORTER.COM&nbsp;&nbsp;(2)</em></a></li>                </ul>
            </td>
        </tr>
    </table>

        <div class="yui-content">
          <form action='/StockControl/Inventory/Recode' method='POST' name='recode' onSubmit="return validateRecodeForm()">
            <input type="hidden" id="dbl_submit_token" name="dbl_submit_token" value="1081">
            ...
            <input type="hidden" name="action" value="recode" />
				...
				<div class="tabInsideWrapper">
                    ...
                    <span class="title title-NAP">Products in Transit</span><br />
                    <table class="data wide-data divided-data" id="transit_items">
                        <thead>
                            <tr height="24">
                                ...
                                <th width="25%" class="tableHeader">Name</th>
                        ...
                        <tbody>
                          ...
                          <tr height="20">
                            <td><a href='/StockControl/Inventory/Overview?variant_id=29'>12-864</a></td>
                            <td>designer</td>
                            <td>Name</td>
                            <td>33L</td>
                            <td>66</td>
                            <td><input data-type="qty" value="0" size="2" name="destroyquantity-12-864" type="text"></td>
                          </tr>


                          <tr height="20">
                            <td><a href='/StockControl/Inventory/Overview?variant_id=32'>13-864</a></td>
                            <td>designer</td>
                            <td>Name</td>
                            <td>33L</td>
                            <td>33</td>
                            <td><input data-type="qty" value="0" size="2" name="destroyquantity-13-864" type="text"></td>
                          </tr>

                        </tbody>
                    </table>
                    <br /><br />
                    <span class="title title-NAP">Recoding Results Wanted</span><br />
                    <table class="data wide-data divided-data" id="recode">
                        <thead>
                            <tr height="24">
                        ...
                        <tbody>
                          <tr class="clonable_row">
                            <td><input data-type="sku" name="newsku_1" type="text"></td>
                            <td><input data-type="qty" value="0" size="2" name="newquantity_1" type="text"></td>
                          </tr>
                          <tr class="add_row">
                            <td class="blank" colspan="5" align="right" style="padding-top:3px">
                              ...
                              <div style="width:90px">
                                ...
                                <a href="#" style="text-decoration: none" id="add_row_button"">
...
$(document).ready(function() {
    ...
    // Clone the row
    $('.clonable_row:first').clone().insertBefore($('.add_row'));

    $('#recode tr[class="clonable_row"]').each( function (i,o) {
    ...
    $('#recode tr[class="clonable_row"]:last input').each( function (i,o) {
...
function validateRecodeForm() {
    ...
    var errorMessage = '';
    $('#recode tr[class="clonable_row"] input').each( function (i,o) {
        ...
        if (!vresult) {
            errorMessage = errorMessage + "\nPlease enter a valid " + dtype + " for field " + $(o).attr('name');
        }
     });
    ...
    <p id="footer">    xTracker-DC  (2011.04.04.15.gd0f5b7e / IWS phase 1). &copy; 2006 - 2011 NET-A-PORTER
</p>
