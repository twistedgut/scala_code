...
StockControl_Sample_ReturnStock.t
...
Test::XTracker::Client::SelfTest->new(
    content    => (join '', (<DATA>)),
    spec       => 'StockControl/Sample/ReturnStock',
    expected => {
        stock_table => [
            {
                'Designer Size' => 'Unknown',
                Location => {
                    input_name => 'o_location_184876-3',
                    input_value => 'Sample Room',
                    value => 'Sample Room'
                },
                Quantity => {
                    input_name => 'o_quantity_184876-3',
                    input_value => '1',
                    value => '1'
                },
                Return => {
                    input_name => 'quantity_184876-3',
                    input_value => '1',
                    value => ''
                },
                ...
                Size => '3',
                Sku => {
                    input_name => 'variant_id_184876-3',
                    input_value => '184876',
                    value => '34300-027'
                }
            }
...
<div id="nav1" class="yuimenubar yuimenubarnav">
    ...
    <div id="content">
        ...
        <ul>
                    ...
                    <li><a href="/StockControl/Inventory/Overview?product_id=34300">Product Overview</a></li>

                    <li><a href="/StockControl/Inventory/ProductDetails?product_id=34300">Product Details</a></li>

                    <li><a href="/StockControl/Inventory/Pricing?product_id=34300">Pricing</a></li>

                    <li><a href="/StockControl/Inventory/Sizing?product_id=34300">Sizing</a></li>

                    <li><a href="/StockControl/PurchaseOrder/Search?variant_id=184876&search=1" class="last">Purchase Orders</a></li>
                    ...
                    <li><a href="/StockControl/Inventory/MoveAddStock?variant_id=184876">Move/Add Stock</a></li>

                    <li><a href="/StockControl/Inventory/StockQuarantine?variant_id=184876">Quarantine Stock</a></li>

                    <li><a href="/StockControl/StockAdjustment/AdjustStock?variant_id=184876" class="last">Adjust Stock</a></li>
                    ...
                    <li><a href="/StockControl/Inventory/Log/Product/DeliveryLog?product_id=34300">Deliveries</a></li>

                    <li><a href="/StockControl/Inventory/Log/Product/AllocatedLog?variant_id=184876" class="last">Allocated</a></li>
                    ...
                    <li><a href="/StockControl/Inventory/Log/Variant/StockLog?variant_id=184876">Transaction Log</a></li>

                    <li><a href="/StockControl/Inventory/Log/Variant/PWSLog?variant_id=184876">PWS Log</a></li>

                    <li><a href="/StockControl/Inventory/Log/Variant/RTVLog?variant_id=184876">RTV Log</a></li>

                    <li><a href="/StockControl/Inventory/Log/Variant/ReservationLog?variant_id=184876">Reservation Log</a></li>

                    <li><a href="/StockControl/Inventory/Log/Variant/CancellationLog?variant_id=184876">Cancellation Log</a></li>

                    <li><a href="/StockControl/Inventory/Log/Variant/LocationLog?variant_id=184876" class="last">Location Log</a></li>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="data">
    <thead>
        ...
        <tr height="24">
            <td colspan="7" class="tableheader">
                &nbsp;&nbsp;&nbsp;<a href="/StockControl/Inventory/Overview?product_id=34300">34300</a>&nbsp;&nbsp;:&nbsp;&nbsp;Hunter - Original Tall Wellington boots
            </td>
        </tr>
        <tr>
    ...
    <tbody>
        ...
        <tr height="100" valign="top">
            <td class="blank">
                <a href="javascript://" onClick="enlargeImage('http://cache.net-a-porter.com/images/products/34300/34300_in_dl.jpg')"><img class="product" height="180" width="120" src="http://cache.net-a-porter.com/images/products/34300/34300_in_m.jpg"></a>
            </td>
            <td class="blank"><img src="/images/blank.gif" width="10" height="1"></td>
            <td class="blank">
                <a href="javascript://" onClick="enlargeImage('http://cache.net-a-porter.com/images/products/34300/34300_bk_dl.jpg')"><img class="product" height="84" width="56" src="http://cache.net-a-porter.com/images/products/34300/34300_bk_xs.jpg"></a>
                <br clear="all">
                <a href="javascript://" onClick="enlargeImage('http://cache.net-a-porter.com/images/products/34300/34300_cu_dl.jpg')"><img class="product" height="84" width="56" src="http://cache.net-a-porter.com/images/products/34300/34300_cu_xs.jpg" style="margin-top:10px"></a>
            </td>
                        ...
                        <td width="47%" class="blank">
                            <table cellpadding="2" cellspacing="0" class="data" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">Shoes / Boots / Flats</td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="divider"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="65%" colspan="2">
                                            ...
                                            <a href="/StockControl/PurchaseOrder/Overview?po_id=6994">HUNCR09SHOEK1</a> &nbsp; &nbsp; <br />



                                            <a href="/StockControl/PurchaseOrder/Overview?po_id=7582">HUNCR09SHOEK2</a> &nbsp; &nbsp; <br />



                                            <a href="/StockControl/PurchaseOrder/Overview?po_id=8942">HUNSHFW09ROK1</a> &nbsp; &nbsp; <br />
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <a href='http://www.net-a-porter.com/product/34300' target='livewindow'>Live</a> : Visible
...
<div style="display:none; margin-top:5px;" id="hideShow_new_comment">
    ...
    <input type="hidden" id="dbl_submit_token" name="dbl_submit_token" value="27579468">
    ...
    <input type="hidden" name="product_id" value="34300" />
        ...
        <tbody>
            <tr height="24">
                ...
                <td width="20%"><input type="text" name="dat" value="20-12-2010 15:51" size="17" readonly="readonly" /></td>
...
<span class="title">Sample Room Stock</span>
<form name="return_stock" action="SetSampleGoodsOut" method="post">
	<input type="hidden" id="dbl_submit_token" name="dbl_submit_token" value="27579468">
...
Sku</td>
				...
				<td class="tableHeader">Designer Size</td>
				<td class="tableHeader">Location</td>
				<td class="tableHeader" align="center">Quantity</td>
				<td class="tableHeader" align="center">Return</td>
			</tr>
			<tr>
		...
		<tbody>
							...
							<tr height="20">
								<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									...
									34300-027
									<input type="hidden" name="variant_id_184876-3" value="184876">
								</td>
								<td><span class="title-NAP">NET-A-PORTER.COM</span></td>
								<td>3</td>
								<td>Unknown</td>
								<td>Sample Room<input type="hidden" name="o_location_184876-3" value="Sample Room"></td>
								<td align="center">1
									<input type="hidden" name="o_quantity_184876-3" value="1">
								</td>
								<td align="center">
									<input type="hidden" name="quantity_184876-3" value="1" />
									<input type="radio" name="return" value="return_184876-3-1">
								</td>
							</tr>
							<tr>
								<td colspan="7" class="divider"></td>
		...
		<input type="hidden" name="variant_id" value="184876">


	<input type="hidden" name="orig_type" value="variant_id">
	<input type="hidden" name="orig_type_id" value="184876">
    ...
    <p id="footer">    xTracker-DC (2010.26.01.14.ga92e048.dirty). &copy; 2006 - 2010 NET-A-PORTER
</p>
