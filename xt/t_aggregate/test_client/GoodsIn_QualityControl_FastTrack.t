...
GoodsIn_QualityControl_FastTrack.t
...
Test::XTracker::Client::SelfTest->new(
    content    => (join '', (<DATA>)),
    spec       => 'GoodsIn/QualityControl/FastTrack',
    expected   => {
        'product_data' => {
            'ID' => '3014963',
            'Purchase Order' => {
                'value' => 'test po 15631',
                'url' => '/StockControl/PurchaseOrder/Overview?po_id=15631'
            },
            'Channels' => [
                {
                    'Upload Date' => '-',
        ...
        'fast_track' => [
            {
                'Counted' => {
                    'input_name' => 'counted_1229154',
                    'value' => '10',
                    'input_value' => '10'
                },
                'Fast Track' => {
                    'input_name' => 'fasttrack_1229154',
                    'value' => '',
                    'input_value' => undef
                },
                'Designer Size' => 'None/Unknown',
                'Quantity' => {
                    'input_name' => 'quantity_1229154',
                    'value' => '',
                    'input_value' => '0'
                },
                'SKU' => '3014963-005'
...
<div id="nav1" class="yuimenubar yuimenubarnav">
    ...
    <div id="content">
        ...
        <ul>
                    ...
                    <li><a href="/GoodsIn/QualityControl/Book?delivery_id=678899" class="last">Back</a></li>
        ...
        <div id="contentRight">
                    ...
                    <div id="pageTitle">
                        ...
                        <h5>&bull;</h5><h3>Fast Track Item</h3>
                    </div>
    ...
    <thead>
        <tr class="divideabove dividebelow">
            <td colspan="7" class="tableheader">
                &nbsp;&nbsp;&nbsp;<a href="/StockControl/Inventory/Overview?product_id=3014963">3014963</a>&nbsp;&nbsp;:&nbsp;&nbsp;Rows - [ <em>Name Required</em> ]&nbsp;&nbsp;&nbsp;<i>Test Description</i>
            </td>
        </tr>
    </thead>
    <tbody>
        ...
        <tr height="100" valign="top">
            <td class="blank">
                ...
                <a href="javascript://" onClick="enlargeImage('http://cache.net-a-porter.com/images/products/3014963/3014963_in_dl.jpg')"><img class="product" width="120" src="http://cache.net-a-porter.com/images/products/3014963/3014963_in_m.jpg"></a>
            </td>
            <td class="blank"><img src="/images/blank.gif" width="10" height="1"></td>
            <td class="blank">
                <a href="javascript://" onClick="enlargeImage('http://cache.net-a-porter.com/images/products/3014963/3014963_bk_dl.jpg')"><img class="product" width="56" src="http://cache.net-a-porter.com/images/products/3014963/3014963_bk_xs.jpg"></a>
                <br clear="all">
                <a href="javascript://" onClick="enlargeImage('http://cache.net-a-porter.com/images/products/3014963/3014963_cu_dl.jpg')"><img class="product" width="56" src="http://cache.net-a-porter.com/images/products/3014963/3014963_cu_xs.jpg" style="margin-top:10px"></a>
            </td>
                            ...
                            <table class="data wide-data divided-data">
                                ...
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <a href="/StockControl/PurchaseOrder/Overview?po_id=15631">test po 15631</a> &nbsp; &nbsp; <br />
...
<div style="display:none; margin-top:5px;" id="hideShow_new_comment">
    ...
    <input type="hidden" id="dbl_submit_token" name="dbl_submit_token" value="27579815">

    <input type="hidden" name="product_id" value="3014963" />
        <thead>
            <tr>
        ...
        <tbody>
            <tr height="24">
                ...
                <td width="20%"><input type="text" name="dat" value="04-01-2011 15:22" size="17" readonly="readonly" /></td>
...
<div id="main_form">
	...
	<span class="title title-NAP">Select Size</span><br>
    <form action="SetFastTrack" method="post" name="fast_track">
    <input type="hidden" name="prod_id" value="3014963">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="data">
        <thead>
            <tr>
...
SKU</td>
                ...
                <td width="10%" class="tableHeader">Counted</td>
                <td width="10%" class="tableHeader">Fast Track</td>
...
3014963-005 <!--(0)--></td>
                    <td>None/Unknown</td>
                    <td>10
		      <input type="hidden" name="counted_1229154" value="10">
                    </td>
                    <td><input type="checkbox" name="fasttrack_1229154">&nbsp;</td>
                    <td><input type="text" size="5" name="quantity_1229154" value="0">&nbsp;</td>
                </tr>
                <tr>
    ...
    <input type="hidden" name="delivery_id" value="678899">
    ...
    <p id="footer">    xTracker-DC (2010.26.01.29.g18e5f10.dirty). &copy; 2006 - 2011 NET-A-PORTER
</p>
