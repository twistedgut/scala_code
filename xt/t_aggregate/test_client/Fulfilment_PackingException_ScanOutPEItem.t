...
Fulfilment_PackingException_ScanOutPEItem.t
...
Test::XTracker::Client::SelfTest->new(
    content    => (join '', (<DATA>)),
    uri        => '/Fulfilment/PackingException/ScanOutPEItem',
    expected   => {
        'shipment_id' => '1893652',
        'item_to_be_scanned' => [{
            Container => 'PH00735700000142',
            Designer => '7 for all mankind',
        ...
        'scan_form' => {
            '' => '',
            Action => 'Return item to pigeonhole PH00735700000142, then click "Submit".',
            SKU => '35099-069'
        }
    }
);
        ...
        <div id="headerLogo">
           ...
           <span>DISTRIBUTION</span><span class="dc">DC1</span>
            ...
            <div id="headerControls">
                Logged in as: <span class="operator_name">Anne Thorniley</span>
...
<div id="nav1" class="yuimenubar yuimenubarnav">
    ...
    <div id="content">
        ...
        <ul>
                    ...
                    <li><a href="/Fulfilment/Packing/CheckShipmentException?shipment_id=1893652" class="last">Back</a></li>
        ...
        <div id="contentRight">
                    ...
                    <div id="pageTitle">
                        ...
                        <h5>&bull;</h5><h3>Scan Container for Cancelled Item</h3>
                    </div>
...
<span class="title title-">Scan Container for Cancelled Item</span><br>
...
<form name="scan_faulty_items"
  ...
  <input type="hidden" name="shipment_id"      value="1893652" />

  <input type="hidden" name="shipment_item_id" value="4195637" />
  <input type="hidden" name="shipment_state_signature" value="5621f4212140a5151232cb5d0b081b02" />
  <input type="hidden" name="situation"        value="removeCancelPending.handleContainer" />
  <input type="hidden" name="transaction_code" value="36356164">
    ...
    <input type="hidden" name="sku" value="35099-069" />

    <div class="formrow dividebelow">

                <span class="fakelabel">Action:</span>
                <input type="hidden" name="empty_container_id" value="PH00735700000142">
                <p>Return item to pigeonhole PH00735700000142, then click "Submit".</p>
...
<span class="title title-">Item to be Scanned</span><br>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="data" id="item-list">
    ...
    <tr valign="middle" height="160"  class="highlight2" >
        <td width="15%"><img src="http://cache.net-a-porter.com/images/products/35099/35099_in_m.jpg" width="120" hspace="5" vspace="5"></td>

        <td width="10%" align="center">35099-069<br><br>(35099)</td>
        <td width="15%">7 for all mankind</td>
        <td width="25%">Mid-rise straight-leg jeans</td>
        <td width="10%">24</td>
        <td width="10%"  class="highlight2" >PH00735700000142</td>
        <td width="15%">
    ...
    <p id="footer">    xTracker-DC  (2011.06.04.50.g832ef17 / IWS phase 2). &copy; 2006 - 2011 NET-A-PORTER
</p>
