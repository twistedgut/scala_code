...
Test::XTracker::Client::SelfTest->new(
    ...
    expected   => {
        stations => [
            ...
            {
                name => 'Item Count Station 1',
                value => 'Item Count Station 1',
            },
            {
                name => 'Item Count Station 2',
                value => 'Item Count Station 2',
            },
            {
                name => 'Item Count Station 3 (spare)',
                value => 'Item Count Station 3 (spare)',
            },
            {
                name => 'Item Count Station 4 (spare)',
                value => 'Item Count Station 4 (spare)',
            },
            {
                name => 'Item Count Station 5 (spare)',
                value => 'Item Count Station 5 (spare)',
            },
        ]
    }
);
...
<html lang="en">
    <head>
        ...
        <title>Select Printer Station &#8226; My &#8226; XT-DC1</title>
...
<div id="nav1" class="yuimenubar yuimenubarnav">
    ...
    <div id="content">
        ...
        <div id="contentRight"class="noleftcol">
                    ...
                    <div id="pageTitle">
                        <h1>GoodsIn</h1>
                        <h5>&bull;</h5><h2>ItemCount</h2>
                        <h5>&bull;</h5><h3>Select Printer Station</h3>
                    </div>
                        ...
                        <span class="display_msg">You need to select your printer station to continue to this page</span><br/><br/>
    <form name="SelectPrinterStation" action="/Admin/Actions/SetPrinterStation" method="post">
        <input type="hidden" id="dbl_submit_token" name="dbl_submit_token" value="1847%3ARcJguSAgMmvODzKmaApzkg">

        <span class="title">Select a Printer Station</span><br/>
        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="data">
            <tr><td colspan="2" class="divider"></td></tr>
            <tr height="24">
                <td width="18%" align="right"><strong>Printer Station:&nbsp;&nbsp;&nbsp;</strong></td>
                <td width="82%">
                    <select name="ps_name">
                        <option value="">-------------------</option>

                            <option value="Item Count Station 1" >Item Count Station 1</option>

                            <option value="Item Count Station 2" >Item Count Station 2</option>

                            <option value="Item Count Station 3 (spare)" >Item Count Station 3 (spare)</option>

                            <option value="Item Count Station 4 (spare)" >Item Count Station 4 (spare)</option>

                            <option value="Item Count Station 5 (spare)" >Item Count Station 5 (spare)</option>

                    </select>
                    <input type="hidden" name="channel_id" value="1" />
                    <input type="hidden" name="section" value="GoodsIn" />
                    <input type="hidden" name="subsection" value="ItemCount" />
                </td>
            </tr>
            <tr><td colspan="2" class="divider"></td></tr>
            <tr>
            ...
            <tr>
                <td colspan="2" class="blank" align="right"><input type="submit" name="submit" class="button" value="Submit &raquo;">
</td>
            </tr>
        </table>
    </form>
