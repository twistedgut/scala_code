...
Fulfilment_Packing_CheckShipment.t
...
Test::XTracker::Client::SelfTest->new(
    content    => (join '', (<DATA>)),
    uri        => '/Fulfilment/Packing/CheckShipment',
    expected   => {
        ...
        shipment_items => [
            {
                Container => 'M020819',
                Designer => 'Alexandre Birman',
                Name => 'Knotted leather slingbacks',
                QC => {
                    input_name => 'shipment_item_qc_3729215',
                    input_value => '1',
                    value => 'OKFailFailure reason'
                },
                SKU => '97025-037',
                Size => 'US 8',
                shipment_item_id => '3729215'
            },
            {
                Container => 'M020819',
                Designer => 'Christian Louboutin',
                Name => 'Simple 70 leather pumps',
                QC => {
                    input_name => 'shipment_item_qc_3729216',
                    input_value => '1',
                    value => 'OKFailFailure reason'
                },
                SKU => '60238-096',
                Size => 'IT 37.5',
                shipment_item_id => '3729216'
            }
        ],
        shipment_summary => {
            Channel => 'NET-A-PORTER.COM',
            Class => 'Customer Order',
            'Customer Name' => '39cfc1 87d0c',
            'Customer No.' => '1060783',
            Instructions => 'Basic Packaging',
            Notes => [],
            'Other Info' => '',
            'Release Date' => '13-02-2011 16:49',
            'Shipment Date' => '13-02-2011 16:30',
            'Shipment Number' => '1652530',
            Type => 'International'
        }
    }
);
    ...
    <div id="content">
        ...
        <div id="contentRight">
                    ...
                    <div id="pageTitle">
                        ...
                        <h5>&bull;</h5><h3>Check Shipment</h3>
                    </div>
...
<span class="title title-NAP">Shipment Summary</span><br>
...
<div class="formrow dividebelow">
    ...
    <!-- Shipment Packing Exception Notes -->
        <div class="shipment-packing-exception-notes">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" class="data" id="quality-control-notes">
                ...
                <input type="hidden" name="shipment_id"   value="1652530">
                <input type="hidden" name="sub_id"        value="1652530">
                <input type="hidden" name="parent_id"     value="1536908">
    ...
    <!-- End Shipment Packing Exception Notes -->
        ...
        <form name="pickShipment" action="/Fulfilment/Packing/ProcessPayment" method="post">
                ...
                <span class="title title-NAP">Items to be Packed</span><br>

            <table width="100%" cellpadding="0" cellspacing="0" border="0" class="data" id="item-list">
                <tr>
                ...
                <tr>
                    <td class="dividerHeader" colspan="7"></td>
                        ...
                        <tr valign="middle" height="160">
                            <td width="15%" rowspan="2"><img src="http://cache.net-a-porter.com/images/products/97025/97025_in_m.jpg" width="120" height="180" hspace="5" vspace="5"></td>
                            <td width="10%" align="center">97025-037<br><br>(97025_6)</td>
                            <td width="15%">Alexandre Birman</td>
                            <td width="25%">Knotted leather slingbacks</td>
                            <td width="10%">US 8</td>
                            <td width="10%">M020819</td>
                            <td width="15%">
                                <input type="radio" class="qc_radio" name="shipment_item_qc_3729215" id="shipment_item_qc_3729215_ok" value="1">
                                    <label for="shipment_item_qc_3729215_ok">OK</label>
                                <input type="radio" class="qc_radio" name="shipment_item_qc_3729215" id="shipment_item_qc_3729215_fail" value="0">
                                    <label for="shipment_item_qc_3729215_fail">Fail</label>
                                <div class="qc_reason">
                                    <label class="qc_reason" for="shipment_item_qc_3729215_reason">Failure reason</label>
                                    <input type="text" class="qc_reason" name="shipment_item_qc_3729215_reason" id="shipment_item_qc_3729215_reason">
                                </div>
                            </td>
                        </tr>
                        <tr height="30">
    ...
    <span class="highlight">&nbsp;</span>
                        ...
                        <tr valign="middle" height="160">
                            <td width="15%" rowspan="2"><img src="http://cache.net-a-porter.com/images/products/60238/60238_in_m.jpg" width="120" height="180" hspace="5" vspace="5"></td>
                            <td width="10%" align="center">60238-096<br><br>(60238_5)</td>
                            <td width="15%">Christian Louboutin</td>
                            <td width="25%">Simple 70 leather pumps</td>
                            <td width="10%">IT 37.5</td>
                            <td width="10%">M020819</td>
                            <td width="15%">
                                <input type="radio" class="qc_radio" name="shipment_item_qc_3729216" id="shipment_item_qc_3729216_ok" value="1">
                                    <label for="shipment_item_qc_3729216_ok">OK</label>
                                <input type="radio" class="qc_radio" name="shipment_item_qc_3729216" id="shipment_item_qc_3729216_fail" value="0">
                                    <label for="shipment_item_qc_3729216_fail">Fail</label>
                                <div class="qc_reason">
                                    <label class="qc_reason" for="shipment_item_qc_3729216_reason">Failure reason</label>
                                    <input type="text" class="qc_reason" name="shipment_item_qc_3729216_reason" id="shipment_item_qc_3729216_reason">
                                </div>
                            </td>
                        </tr>
                        <tr height="30">
...
jQuery(function() {
 ...
 var status={"shipment_item_qc_3729215": -1,"shipment_item_qc_3729216": -1,0:-1};
...
//]]></script>
        ...
        <input type="hidden" id="dbl_submit_token" name="dbl_submit_token" value="30780617">

            <tr>
                <td align="right">
                    <input type="hidden" name="shipment_id" value="1652530">

                            <input type="hidden" name="container_id" value="M020819">


                        <input type="submit" name="qc_do" class="button" value="Check items!">
    ...
    <p id="footer">    xTracker-DC  (2011.01.15.124.gf22970c / IWS phase 0). &copy; 2006 - 2011 NET-A-PORTER
</p>
