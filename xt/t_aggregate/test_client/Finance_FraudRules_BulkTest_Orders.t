...
Finance_FraudRules_BulkTest_Orders.t
    ...
    <div id="headerTop">
        ...
        <div id="headerControls">
                ...
                <form class="quick_search" method="get" action="/QuickSearch">
                    ...
                    <input type="hidden" id="dbl_submit_token" name="dbl_submit_token" value="191%3AUt%2FrXut2mJwGnJ52eEQOtw">
...
<div id="nav1" class="yuimenubar yuimenubarnav">
    ...
    <div id="content">
        ...
        <div id="contentRight">
                        ...
                        <p class="error_msg">Some of the order numbers are invalid, please check and try again.</p>
  ...
  <ul class="breadcrumb">
                    ...
                    <form name="bulk_test" id="bulk_test" method="post" action="/Finance/FraudRules/BulkTest">
    ...
    <div class="formrow divideabove">
        ...
        <select name="expected_result" id="expected_result">

                <option value="1" selected="selected">Credit Hold</option>

                <option value="2">Credit Check</option>
    ...
    <div class="formrow dividebelow divideabove">
        ...
        <textarea name="orders" id="orders" style="width:650px; height: 100px">1</textarea>
    </div>

    <div class="formrow aftertable buttons formend">
        <input type="submit" name="submit" class="button" value="Test &raquo;">
    ...
    <table id="table_invalid_order_numbers" class="data wide-data">
    ...
    <p id="footer">    xTracker-DC  (2013.03.00.5.31.14.g320d43f / IWS phase 2 / PRL phase 0 / 2013-03-11 16:51:08). &copy; 2006 - 2013 NET-A-PORTER
</p>
