...
StockControl_Sample_GoodsOut.t
...
Test::XTracker::Client::SelfTest->new(
    content    => (join '', (<DATA>)),
    spec       => 'StockControl/Sample/GoodsOut',
    expected   => {
        'product_data' => {
            'ID' => '3014985',
            'Purchase Order' => {
        ...
        'goods_out' => [
            {
                ...
                'Move to Stock' => {
                    'input_name' => 'vendor_sample-1120705-1',
                    'value' => '',
                    'input_value' => '1120705'
                },
                'Quantity' => '1',
...
<div id="nav1" class="yuimenubar yuimenubarnav">
    ...
    <div id="content">
        ...
        <ul>
                    ...
                    <li><a href="/StockControl/Inventory/Overview?product_id=3014985">Product Overview</a></li>

                    <li><a href="/StockControl/Inventory/ProductDetails?product_id=3014985">Product Details</a></li>

                    <li><a href="/StockControl/Inventory/Pricing?product_id=3014985">Pricing</a></li>

                    <li><a href="/StockControl/Inventory/Sizing?product_id=3014985">Sizing</a></li>

                    <li><a href="/StockControl/PurchaseOrder/Search?variant_id=1120705&search=1" class="last">Purchase Orders</a></li>
                    ...
                    <li><a href="/StockControl/Sample/PurchaseOrder?variant_id=1120705">Purchase Order</a></li>

                    <li><a href="/StockControl/Sample/SamplesIn?variant_id=1120705">Sample Goods In</a></li>

                    <li><a href="/StockControl/Sample/GoodsOut?variant_id=1120705">Sample Rotation</a></li>

                    <li><a href="/StockControl/Sample/RequestStock?variant_id=1120705">Request Stock</a></li>

                    <li><a href="/StockControl/Sample/ReturnStock?variant_id=1120705">Return Stock</a></li>

                    <li><a href="/Sample/SampleCart/Process/AddItemVariant?action=add&variant_id=1120705" class="last">Add to Sample Cart</a></li>
                    ...
                    <li><a href="/StockControl/Inventory/Log/Product/DeliveryLog?product_id=3014985">Deliveries</a></li>

                    <li><a href="/StockControl/Inventory/Log/Product/AllocatedLog?variant_id=1120705" class="last">Allocated</a></li>
                    ...
                    <li><a href="/StockControl/Inventory/Log/Variant/StockLog?variant_id=1120705">Transaction Log</a></li>

                    <li><a href="/StockControl/Inventory/Log/Variant/PWSLog?variant_id=1120705">PWS Log</a></li>

                    <li><a href="/StockControl/Inventory/Log/Variant/RTVLog?variant_id=1120705">RTV Log</a></li>

                    <li><a href="/StockControl/Inventory/Log/Variant/ReservationLog?variant_id=1120705">Reservation Log</a></li>

                    <li><a href="/StockControl/Inventory/Log/Variant/CancellationLog?variant_id=1120705">Cancellation Log</a></li>

                    <li><a href="/StockControl/Inventory/Log/Variant/LocationLog?variant_id=1120705" class="last">Location Log</a></li>
        ...
        <div id="contentRight">
                    ...
                    <div id="pageTitle">
                        <h1>Stock Control</h1>
                        <h5>&bull;</h5><h2>Vendor Sample</h2>
                        <h5>&bull;</h5><h3>Goods Out to DC</h3>
                    </div>
                    ...
                    <!-- TT BEGIN="xtracker/trunk/perl/XTracker/tt/stocktracker/sample/goodsout.tt" -->
...
<div style="display:none; margin-top:5px;" id="hideShow_new_comment">
    ...
    <input type="hidden" id="dbl_submit_token" name="dbl_submit_token" value="27580146">
    ...
    <input type="hidden" name="product_id" value="3014985" />
        ...
        <tbody>
            <tr height="24">
                ...
                <td width="20%"><input type="text" name="dat" value="05-01-2011 12:51" size="17" readonly="readonly" /></td>
...
<div id="main_form">
<form name="VendorSampleGoodsOut" method="post" action="/StockControl/Sample/SetSampleGoodsOutToStock">
<input type="hidden" name="product_id" value="3014985" />
<input type="hidden" id="dbl_submit_token" name="dbl_submit_token" value="27580146">
...
SKU</td>
		...
		<td class="tableHeader" align="center">Move to Stock</td>
	</tr>
	<tr>
...
3014985-005</td>
			...
			<td align="center">1
				...
				<td align="center"><input type="checkbox" name="vendor_sample-1120705-1" value="1120705" /></td>
...
<!-- TT END="xtracker/trunk/perl/XTracker/tt/stocktracker/sample/goodsout.tt" -->
