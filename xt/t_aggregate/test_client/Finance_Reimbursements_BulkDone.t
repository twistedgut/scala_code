...
Finance_Reimbursements_BulkDone.t
...
Test::XTracker::Client::SelfTest->new(
    content    => (join '', (<DATA>)),
    uri        => '/Finance/Reimbursements/BulkDone',
    expected   => {
        bulk_reimbursement_result   => 'Advise user to check messages for update',
        bulk_reimbursement_id       => 207,
    },
);
        ...
        <div id="headerLogo">
           ...
           <span>DISTRIBUTION</span><span class="dc">DC1</span>
            ...
            <div id="headerControls">
                Logged in as: <span class="operator_name">Andrew Benson</span>
...
<div id="nav1" class="yuimenubar yuimenubarnav">
    ...
    <div id="content">
        ...
        <div id="contentRight">
                    ...
                    <!-- BEGIN root/base/finance/reimbursements/bulk_done.tt_done -->
<div id="bulk_reimbursement_result">        <span id="bulk_reimbursement_id" style="visibility:hidden">207</span>

        <h2>Advise user to check messages for update</h2></div>
<!-- END root/base/finance/reimbursements/bulk_done.tt -->
    ...
    <p id="footer">    xTracker-DC  (2011.08.06.13.g2027de9 / IWS phase 1). &copy; 2006 - 2011 NET-A-PORTER
