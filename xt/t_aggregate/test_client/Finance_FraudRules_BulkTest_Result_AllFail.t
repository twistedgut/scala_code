...
Finance_FraudRules_BulkTest_Result_AllFail.t
    ...
    <div id="headerTop">
        ...
        <div id="headerControls">
                ...
                <form class="quick_search" method="get" action="/QuickSearch">
                    ...
                    <input type="hidden" id="dbl_submit_token" name="dbl_submit_token" value="152%3AJmsuIyWt13%2F4WsukuyCrwA">
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td width="20%" />
                ...
                <td width="20%" />
                    ...
                    <td id="td_all_failed" width="20%" class="fraudscreen___test_pass_fail fraudscreen__test_fails">Both Orders Failed</td>
        ...
        <table id="table_order_failures" class="data wide-data">
            ...
            <tbody>
                    ...
                    <tr class="dividebelow" id="table_failures_row_1000000003">
