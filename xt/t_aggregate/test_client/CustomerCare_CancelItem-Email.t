...
CustomerCare_CancelItem-Email.t
...
Test::XTracker::Client::SelfTest->new(
    ...
    expected   => {
        cancel_item_form => {
            action => '/CustomerCare/CustomerSearch/ChangeShipmentItemStatus?order_id=1306021&shipment_id=1385722',
            hidden_input => {
                name => 'status_id',
                value => '10'
            },
...
href="http://xtdc1-frank:8529/favicon.ico">
        ...
        <!-- Core Javascript -->
        <script type="text/javascript" src="CancelShipmentItem-Email_files/common.js"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/xt_navigation.js"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/form_validator.js"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/validate.js"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/comboselect.js"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/date.js"></script>
        ...
        <!-- YUI majik -->
        <script type="text/javascript" src="CancelShipmentItem-Email_files/yahoo-dom-event.js"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/container_core-min.js"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/menu-min.js"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/animation.js"></script>
        <!-- dialog dependencies -->
        <script type="text/javascript" src="CancelShipmentItem-Email_files/element-min.js"></script>
        <!-- Scripts -->
        <script type="text/javascript" src="CancelShipmentItem-Email_files/utilities.js"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/container-min.js"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/yahoo-min.js"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/dom-min.js"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/element-min.js"></script>

        <script type="text/javascript" src="CancelShipmentItem-Email_files/datasource-min.js"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/datatable-min.js"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/tabview-min.js"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/slider-min.js"></script>
        <!-- Connection Dependencies -->
        <script type="text/javascript" src="CancelShipmentItem-Email_files/event-min.js"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/connection-min.js"></script>
        <!-- YUI Autocomplete sources -->
        <script type="text/javascript" src="CancelShipmentItem-Email_files/autocomplete-min.js"></script>

        <!-- calendar -->
        <script type="text/javascript" src="CancelShipmentItem-Email_files/calendar.js"></script>
        <!-- Custom YUI widget -->
        <script type="text/javascript" src="CancelShipmentItem-Email_files/Editable.js"></script>
        <!-- CSS -->
        <link rel="stylesheet" type="text/css"
href="CancelShipmentItem-Email_files/grids-min.css">
        <link rel="stylesheet" type="text/css"
href="CancelShipmentItem-Email_files/button.css">
        <link rel="stylesheet" type="text/css"
href="CancelShipmentItem-Email_files/datatable.css">
        <link rel="stylesheet" type="text/css"
href="CancelShipmentItem-Email_files/tabview.css">
        <link rel="stylesheet" type="text/css"
href="CancelShipmentItem-Email_files/menu.css">
        <link rel="stylesheet" type="text/css"
href="CancelShipmentItem-Email_files/container.css">
        <link rel="stylesheet" type="text/css"
href="CancelShipmentItem-Email_files/autocomplete.css">
        <link rel="stylesheet" type="text/css"
href="CancelShipmentItem-Email_files/calendar.css">
        <!-- (end) YUI majik -->

        <!-- Load jQuery -->
        <script type="text/javascript" src="CancelShipmentItem-Email_files/jquery-1.html"></script>
        <script type="text/javascript" src="CancelShipmentItem-Email_files/jquery-ui.js"></script>
        <!-- jQuery CSS -->
        <link rel="stylesheet" type="text/css"
href="CancelShipmentItem-Email_files/jquery-ui.css">
...
href="CancelShipmentItem-Email_files/xtracker.css">
        <link rel="stylesheet" type="text/css" media="screen"
href="CancelShipmentItem-Email_files/xtracker_static.css">
        <link rel="stylesheet" type="text/css" media="screen"
href="CancelShipmentItem-Email_files/customer.css">
        <link rel="stylesheet" type="text/css" media="print"
href="CancelShipmentItem-Email_files/print.css">
...
border-width: 0pt;" title="Text Resize Monitor" id="_yuiResizeMonitor"></iframe>
    ...
    <div id="headerTop">
        <div id="headerLogo">
           <img src="CancelShipmentItem-Email_files/logo_small.gif"
alt="xTracker">
...
class="messages"><img
src="CancelShipmentItem-Email_files/email_open.png" alt="Messages"
title="No New Messages" height="16" width="16"></a>
...
Choo</option>
    ...
    <div id="headerBottom">
        <img src="CancelShipmentItem-Email_files/model_INTL.jpg" alt=""
height="87" width="157">
    </div>
...
class="yuimenuitemlabel">Magazine</a>
    ...
    <div id="content">
        ...
        <ul>
            ...
            <img id="channelTitle"
src="CancelShipmentItem-Email_files/logo_NET-A-PORTER_INTL.gif"
alt="NET-A-PORTER.COM">
        ...
        <span class="title title-NAP">Cancelled Item(s)</span><br>

        <form name="cancelForm"
action="/CustomerCare/CustomerSearch/ChangeShipmentItemStatus?order_id=1306021&amp;shipment_id=1385722"
 method="post">
        <input name="status_id" value="10" type="hidden">
        <table class="data" width="100%" border="0" cellpadding="0"
cellspacing="0">
        <input id="dbl_submit_token" name="dbl_submit_token" value="24800291" type="hidden">

            <tbody><tr>
                <td colspan="4" class="dividerHeader"><img
src="CancelShipmentItem-Email_files/blank.gif" height="1" width="1"></td>
            </tr>
            <tr height="24">
                <td class="tableHeader" width="15%">&nbsp;&nbsp;&nbsp;PID</td>
                <td class="tableHeader" width="30%">Name</td>
                <td class="tableHeader" width="15%">Size</td>
                <td class="tableHeader" width="40%">Reason</td>
            </tr>
            <tr>
                <td colspan="4" class="dividerHeader"><img
src="CancelShipmentItem-Email_files/blank.gif" height="1" width="1"></td>
...
onclick="window.open('/OrderTracker/ViewImages/11861','viewimage','width=230,height=345,scrollbars=no');"
 class="noline">81020-557</a></td>
                        <td>Rhodium-plated double ring</td>
                        <td>13</td>
                        <td>Other</td>
                    </tr>
                    <tr>
                        <td colspan="4" class="divider"><img
src="CancelShipmentItem-Email_files/blank.gif" height="1" width="1"></td>
                    </tr>
                    <input name="item-3188091" value="1" type="hidden">
                    <input name="reason-3188091" value="30"
type="hidden">
...
checked="checked" type="radio">&nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;<input
 name="send_email" value="no" type="radio">&nbsp;&nbsp;No</td>
            </tr>
            <tr>
                <td colspan="2" class="divider"></td>
            </tr>
...
value="bd40e87ffba093f9ec8a464a67" type="text"></td>
            </tr>
            <tr>
                <td colspan="2" class="divider"></td>
            </tr>
...
value="customercare@net-a-porter.com" type="text"></td>
            ...
            <tr height="30">
                ...
                <td><input size="35" name="email_subject" value="Your
order - 1173570" type="text"></td>
            </tr>
            <tr>
                <td colspan="2" class="divider"></td>
            </tr>
...
Thank you for your email requesting the cancellation of the following:

 - Versace Rhodium-plated double ring
...
src="CancelShipmentItem-Email_files/blank.gif" height="15" width="1"></td>
            </tr>
            <tr>
                <td class="blank" colspan="2" align="right"><input
name="submit" class="button" value="Submit »" type="submit">
</td>
            </tr>
