...
Finance_FraudRules_BulkTest_Result_PassFail.t
...
Test::XTracker::Client::SelfTest->new(
    content    => ( join '', (<DATA>) ),
    uri        => '/Finance/FraudRules/BulkTest',
    expected   => {
        order_passes       => '1 Order Passed',
        order_failures     => '1 Order Failed',
        order_failure_list => [
            {
                'Order Number' => {
                ...
                'Deciding Rule' => 'Accept Over Zero',
        ...
        order_pass_list => [
            {
                'Order Number' => {
                    url => '/CustomerCare/OrderSearch/OrderView?order_id=4',
                    value => '1000000003'
                },
                'Deciding Rule' => 'Orders Over 1000 Go On Credit Hold',
...
<html lang="en">
    <head>
        ...
        <title>Fraud Rules &#8226; Finance &#8226; XT-DC1</title>
        ...
        <!-- Custom CSS -->
            ...
            <link rel="stylesheet" type="text/css" href="/css/fraudrules-bulktest.css">
    ...
    <div id="headerTop">
        ...
        <div id="headerControls">
                ...
                <form class="quick_search" method="get" action="/QuickSearch">
                    ...
                    <input type="hidden" id="dbl_submit_token" name="dbl_submit_token" value="156%3AILz2iOpjVr89vf%2FJG7C6Xg">
...
<div id="nav1" class="yuimenubar yuimenubarnav">
    ...
    <div id="content">
        ...
        <ul>
                    ...
                    <li><a href="/Finance/FraudRules/ViewLiveRules">Live Rules</a></li>

                    <li><a href="/Finance/FraudRules/ViewStagingRules">Staging Rules</a></li>

                    <li><a href="/Finance/FraudRules/BulkTest" class="last">Bulk Test</a></li>
        ...
        <div id="contentRight">
                    ...
                    <div id="pageTitle">
                        <h1>Finance</h1>
                        <h5>&bull;</h5><h2>Fraud Rules</h2>
                        <h5>&bull;</h5><h3>Bulk Test</h3>
                    </div>
  ...
  <ul class="breadcrumb">
    ...
    <span id="ruleset">Staging</span>
</div>

<div class="formrow divideabove">
    <label for="expected_result">Expected Result:</label>
    <span id="expected_result">Credit Hold</span>
</div>

<div class="formrow divideabove">
    <label for="orders">Order Count:</label>
    <span id="orders" style="width:650px; height: 100px">2</span>
</div>
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td width="20%" />
                ...
                <td id="td_order_passes" width="20%" class="fraudscreen___test_pass_fail fraudscreen__test_passes">1 Order Passed</td>

                <td width="20%" />

                <td id="td_order_failures" width="20%" class="fraudscreen___test_pass_fail fraudscreen__test_fails">1 Order Failed</td>
        ...
        <table id="table_order_failures" class="data wide-data">
            ...
            <tbody>
                    ...
                    <tr class="dividebelow" id="table_failures_row_1000000001">
                        <td><a href="/CustomerCare/OrderSearch/OrderView?order_id=2">1000000001</a></td>
                        <td>Accept Over Zero</td>
                        <td>Accepted</td>
                    </tr>
        ...
        <table id="table_order_passes" class="data wide-data">
            ...
            <tbody>
                    ...
                    <tr class="dividebelow" id="table_passes_row_1000000003">
                        <td><a href="/CustomerCare/OrderSearch/OrderView?order_id=4">1000000003</a></td>
                        <td>Orders Over 1000 Go On Credit Hold</td>
                        <td>Credit Hold</td>
                    </tr>
    ...
    <p id="footer">    xTracker-DC  (2013.03.01.171.gc56d68a / IWS phase 2 / PRL phase 0 / 2013-03-22 15:01:11). &copy; 2006 - 2013 NET-A-PORTER
</p>
