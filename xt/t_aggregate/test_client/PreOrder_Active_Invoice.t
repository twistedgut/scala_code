...
Test::XTracker::Client::SelfTest->new(
    content    => (join '', (<DATA>)),
    uri        => '/Finance/ActiveInvoices/PreOrderInvoice?preorder_id=1351363&action=Edit&invoice_id=50',
    expected   => {
  invoice_details => {
    'Change Status' => {
      ...
      value => 'Choose Status.... Cancelled Complete Please note: Changing the status to "Completed" will not process the refund.'
    },
    Reason => [
      'Cancel',
      ''
...
<html lang="en">
    <head>
        ...
        <title>Active Invoices &#8226; Finance &#8226; XT-DC1</title>
...
<div id="nav1" class="yuimenubar yuimenubarnav">
    ...
    <div id="content">
        ...
        <ul>
                    ...
                    <li><a href="/Finance/ActiveInvoices" class="last">Back</a></li>
        ...
        <div id="contentRight">
                    ...
                    <div id="pageTitle">
                        <h1>Finance</h1>
                        <h5>&bull;</h5><h2>Active Invoices</h2>
                        <h5>&bull;</h5><h3>Edit Invoice</h3>
                    </div>
    ...
    <span class="title title-NAP">Pre-Order Details</span><br />
    <form name="refundForm" action="/Finance/ActiveInvoices/UpdatePreOrderInvoice?invoice_id=24&preorder_id=24" method="post">
    <input type="hidden" id="dbl_submit_token" name="dbl_submit_token" value="1536590%3AqeOmptA9mj7zSuCtLyYpZA">

    <table id="preorder_details_form" width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <input type="hidden" name="currency_id" value="">
        ...
        <tr>
            <td width="130" align="right"><b>Pre-Order Number:&nbsp;&nbsp;</td>
            <td width="170">&nbsp;P1351336</td>
    ...
    <table id="invoice_details" width="100%" cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>
            <td width="130" align="right"><b>Reason:&nbsp;&nbsp;</td>
            <td width="170">&nbsp;
                    Cancel
            </td>
            <td><img src="/images/blank.gif" width="1" height="24"></td>
        ...
        <tr>
            <td width="130" align="right"><b> Change Status:&nbsp;&nbsp;</td>
            <td width="570">&nbsp;
                    <select name="status_id">
                        <option value="novalue" selected>Choose Status.... </option>
        ...
        <tr>
            <td colspan="9" class="blank"><img src="/images/blank.gif" width="1" height="15"></td>
        </tr>
        <tr>
            <td colspan="9" class="blank" align="right">
                <input class="button" type="submit" name="" id="refund_update_button" value="Update Invoice &raquo;">
            </td>
        </tr>
...
<span class="title title-NAP">Invoice Items</span>
<br>



    <table id="invoice_items" width="100%" cellpadding="0" cellspacing="0" border="0" class="data">
        <tr>
            <td colspan="9" class="dividerHeader"><img src="/images/blank.gif" width="1" height="1"></td>
        </tr>
        <tr height="24">
            <td class="tableHeader" width="12%">&nbsp;&nbsp;&nbsp;SKU</td>
            <td class="tableHeader" width="29%">Product Name</td>
            <td class="tableHeader" width="20%">Designer</td>
            <td class="tableHeader" width="10%">Unit Price&nbsp;&nbsp;&nbsp;</td>
            <td class="tableHeader" width="10%">Tax&nbsp;</td>
            <td class="tableHeader" width="10%">Duties&nbsp;</td>
            <td class="tableHeader" width="12%">Sub-Total&nbsp;&nbsp;</td>
        </tr>
        <tr>
            <td colspan="9" class="dividerHeader"><img src="/images/blank.gif" width="1" height="1"></td>
        </tr>
        ...
        <tr height="24" bgcolor="#ffffff">
            <td class="blank" colspan="5"><img src="/images/blank.gif" width="1" height="24"></td>
            <td class="blank"><b>Grand Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td class="blank"><b>&nbsp;1725.00&nbsp;&nbsp;GBP</b></td>
        </tr>
            <tr>
                <td colspan="9" class="divider"><img src="/images/blank.gif" width="1" height="1"></td>
            </tr>
...
<span class="title title-NAP">Invoice Status Log</span>
<br>
<table id="invoice_status_log" width="100%" cellpadding="0" cellspacing="0" border="0" class="data">
    <tr>
    ...
    <script language="Javascript">
        ...
        $('#refund_update_button').click(function() {
        if (confirm('Are you sure you want to update the status?')) {
            $('#preorder_details_form').submit();
        } else {
            return false;
        }
    });
    ...
    <p id="footer">    xTracker-DC  (2012.08.00.10.g6c40435 / IWS phase 2 / PRL phase 0 / 2012-06-13 15:50:41). &copy; 2006 - 2012 NET-A-PORTER
</p>
