...
Test::XTracker::Client::SelfTest->new(
    content    => (join '', (<DATA>)),
    uri        => '/Finance/StoreCredits/Create',
    expected   => {
        page_data => {
          '' => '',
          Currency => {
...
<html lang="en">
    <head>
        ...
        <title>Store Credits &#8226; Finance &#8226; XT-DC3</title>
    ...
    <div id="headerTop">
        <div id="headerLogo">
           <table>
              <tr>
                 <td valign="bottom"><img width="35px" height="35px" src="/images/flag_APAC.png"></td>
                 <td>
                    <img src="/images/logo_small.gif" alt="xTracker">
                    <span>DISTRIBUTION</span><span class="dc">DC3</span>
                 </td>
              </tr>
           </table>
        </div>
    ...
    <div id="headerBottom">
        <img src="/images/model_APAC.jpg" width="157" height="87" alt="">
    </div>
...
<div id="nav1" class="yuimenubar yuimenubarnav">
    ...
    <div id="content">
        ...
        <ul>
                    ...
                    <li><a href="http://10.5.16.161:8529/Finance/StoreCredits" class="last">Back</a></li>
        ...
        <div id="contentRight">
                    ...
                    <div id="pageTitle">
                        <h1>Finance</h1>
                        <h5>&bull;</h5><h2>Store Credits</h2>
                    ...
                    <span class="title title-">Credit Details</span>

<form method="POST" action="http://10.5.16.161:8529/Finance/StoreCredits/Create" name="create_store_credit" id="create_store_credit">
<input type="hidden" id="dbl_submit_token" name="dbl_submit_token" value="255:1PeimpIV2onH5vXskJslGw">
    ...
    <div class="formrow divideabove dividebelow">
        ...
        <p class="inline"><select id="channel" name="channel">

            <option value="9">NET-A-PORTER.COM</option>

            <option value="10">theOutnet.com</option>

            <option value="11">MRPORTER.COM</option>

            <option value="12">JIMMYCHOO.COM</option>

        </select></p>
    </div>

    <div class="formrow dividebelow">
        <label for="customer_nr">Customer Number:</label>
        <p class="inline"><input id="customer_nr" name="customer_nr" type="text"></p>
    </div>


    <div class="formrow dividebelow">
        <label for="value">Value:</label>
        <p class="inline"><input id="value" name="value" type="text" value="0.00" class="smallest" size="5"></p>
    </div>

    <div class="formrow dividebelow">
        <label for="currency">Currency:</label>
        <p class="inline"><select id="currency" name="currency" class="smallest">
    ...
    <div class="formrow dividebelow">
        ...
        <p class="inline"><input id="notes" name="notes" type="text" value="" size="255"></p>
    </div>

    <div class="formrow buttons formend aftertable">
        <input type="submit" value="Create Store Credit &raquo;" class="button">
    </div>
    ...
    <p id="footer">    xTracker-DC  (2012.14.04.22.gc73d365 / IWS phase 0 / PRL phase 0 / 2012-11-07 09:13:31). &copy; 2006 - 2012 NET-A-PORTER
</p>
