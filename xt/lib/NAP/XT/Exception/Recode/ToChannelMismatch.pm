package NAP::XT::Exception::Recode::ToChannelMismatch;
...
Thrown if when recoding a variant, one of the created variants is not of the same channel
as the variant(s) that it has been created from
