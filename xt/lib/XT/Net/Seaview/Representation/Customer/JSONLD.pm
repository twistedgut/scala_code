package XT::Net::Seaview::Representation::Customer::JSONLD;
...
XT::Net::Seaview::Representation::Customer::JSONLD

=head1 DESCRIPTION

XT customer objects as Seaview-able JSONLD representations
...
Create a JSON-LD representation of this customer
