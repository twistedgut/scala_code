use utf8;
package XTracker::Schema::Result::Public::LogPwsStock;
...
__PACKAGE__->table("public.log_pws_stock");
...
# Created by DBIx::Class::Schema::Loader
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:cKMDCDsSf2t72czScRlz8A
