...
UPDATE country_shipping_charge SET channel_id = 1;
...
UPDATE state_shipping_charge SET channel_id = 1;
...
UPDATE postcode_shipping_charge SET channel_id = 1;
...
INSERT INTO carrier VALUES (3, 'DHL Ground', '80916');
DELETE from carrier WHERE name = 'UPS';
...
UPDATE shipping_account SET channel_id = 1;
...
INSERT INTO manifest_run_number VALUES (5);

GRANT ALL ON manifest_run_number TO www;


-- create LP sequence for DHL Ground
CREATE SEQUENCE dhl_ground_licence_plate_nr MINVALUE 80916000100 MAXVALUE 80916999999 START 80916000100;
