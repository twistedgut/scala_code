...
BEGIN;
    ...
    SELECT p.id, 1, p.live, p.staging, p.visible, p.disableupdate, upload.upload_date, 1
    ...
    UPDATE purchase_order SET channel_id = 1;
    ...
    UPDATE customer SET channel_id = 1;
    ...
    UPDATE customer_credit SET channel_id = 1;
    ...
    UPDATE log_stock SET channel_id = 1;
    ...
    UPDATE log_rtv_stock SET channel_id = 1;
    ...
    UPDATE log_pws_stock SET channel_id = 1;
    ...
    UPDATE log_location SET channel_id = 1;
    ...
    UPDATE old_log_location SET channel_id = 1;
    ...
    UPDATE reservation SET channel_id = 1;
    ...
    UPDATE location SET channel_id = 1 WHERE type_id = 1;
    ...
    UPDATE quantity SET channel_id = 1;
    ...
    UPDATE product.stock_summary SET channel_id = 1;
    ...
    UPDATE hotlist_value SET channel_id = 1;
    ...
    UPDATE stock_transfer SET channel_id = 1;
    ...
    UPDATE sample_request SET channel_id = 1;
    ...
    UPDATE sample_request_cart SET channel_id = 1;
    ...
    UPDATE product.attribute SET channel_id = 1;
	...
	UPDATE inner_box SET channel_id = 1;
