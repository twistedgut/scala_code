...
-- These boxes were listed as small boxes in config for DC3, so their is_conveyable
...
-- These boxes were listed as large boxes in config for DC3, so their is_conveyable
-- and requires_tote flags are set accordingly
