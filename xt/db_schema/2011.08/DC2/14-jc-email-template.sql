...
SET content = REPLACE(content, 'For assistance email customercare.usa@mrporter.com or call +1 877 5353 MRP (677) 24 hours a day, seven days a week', 
'For assistance email customercare.usa@mrporter.com or call +1 877 5353 MRP (677) 24 hours a day, seven days a week
...
Your order has now been shipped and your [% shipment_row.shipping_account.carrier.name %] tracking number is [% shipment.outward_airway_bill %].

[% IF shipment_row.shipping_account.carrier.name == \'DHL\' %]Using this number you can track your package on the DHL website, http://www.dhl.com.[% ELSIF shipment_row.shipping_account.carrier.name == \'UPS\' %]Using this number you can track your package on the UPS website, http://www.ups.com.[% END %] 

Please be aware that, while your shipment has been processed and dispatched, it will take several hours before your number will register on the [% shipment_row.shipping_account.carrier.name %] website.
...
If you have any questions about your order that are not answered on our website, please email customercare.usa@jimmychooonline.com.
