...
-- tax code for DC1 only
UPDATE channel SET default_tax_code = 'GB 743 7967 86' WHERE web_name IN ('NAP-INTL', 'OUTNET-INTL', 'MRP-INTL');

UPDATE channel SET default_tax_code = 'GB 849 1509 05' WHERE web_name IN ('JC-INTL');
