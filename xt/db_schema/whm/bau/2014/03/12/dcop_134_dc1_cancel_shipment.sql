-- DCOP-134 Cancel shipment

BEGIN;

CREATE OR REPLACE FUNCTION dcop_134_cancel(val_shipment_id INTEGER, val_shipment_item_id INTEGER) RETURNS VOID AS $$
...
SELECT dcop_134_cancel(4990777,10821188);
DROP FUNCTION dcop_134_cancel(int,int);
