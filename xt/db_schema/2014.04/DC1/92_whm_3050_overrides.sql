BEGIN;
    ...
    (
        (
            SELECT id FROM sos.processing_time
            WHERE country_id = (SELECT id FROM sos.country WHERE api_code = 'AR')
        ),
        (
            SELECT id FROM sos.processing_time
            WHERE class_id = (SELECT id FROM sos.shipment_class WHERE api_code = 'STANDARD')
    ...
    (
        (
            SELECT id FROM sos.processing_time
            WHERE country_id = (SELECT id FROM sos.country WHERE api_code = 'BH')
        ),
        (
            SELECT id FROM sos.processing_time
            WHERE class_id = (SELECT id FROM sos.shipment_class WHERE api_code = 'STANDARD')
    ...
    (
        (
            SELECT id FROM sos.processing_time
            WHERE country_id = (SELECT id FROM sos.country WHERE api_code = 'NG')
        ),
        (
            SELECT id FROM sos.processing_time
            WHERE class_id = (SELECT id FROM sos.shipment_class WHERE api_code = 'STANDARD')
    ...
    (
        (
            SELECT id FROM sos.processing_time
            WHERE country_id = (SELECT id FROM sos.country WHERE api_code = 'ZA')
        ),
        (
            SELECT id FROM sos.processing_time
            WHERE class_id = (SELECT id FROM sos.shipment_class WHERE api_code = 'STANDARD')
    ...
    (
        (
            SELECT id FROM sos.processing_time
            WHERE country_id = (SELECT id FROM sos.country WHERE api_code = 'AE')
        ),
        (
            SELECT id FROM sos.processing_time
            WHERE class_id = (SELECT id FROM sos.shipment_class WHERE api_code = 'STANDARD')
