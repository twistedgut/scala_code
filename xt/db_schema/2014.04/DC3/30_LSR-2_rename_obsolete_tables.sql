...
ALTER TABLE public.link_product__ship_restriction_backup RENAME TO public_link_product__ship_restriction_backup;
ALTER TABLE public.public_link_product__ship_restriction_backup SET SCHEMA obsolete;
