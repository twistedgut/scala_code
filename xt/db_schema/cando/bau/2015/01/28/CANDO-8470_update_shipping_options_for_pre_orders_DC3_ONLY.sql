...
-- CANDO-8470: Update the Shipping Option of several Pre-Orders which are
...
SELECT  pre.id,
        ...
        'BAU (CANDO-8470) to update Shipping Option from ''(9000330-001) Sydney and Melbourne Next Business Day'' to ''(9000314-001) Standard 2-4 days Australia'', so that the Pre-Orders can be converted into Orders.'
FROM    pre_order pre
