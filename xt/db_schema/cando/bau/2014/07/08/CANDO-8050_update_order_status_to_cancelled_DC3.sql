...
-- CANDO-8050: Updates the Order Status of 710191229
...
INSERT INTO order_note (orders_id, note_type_id, operator_id, date, note ) VALUES (
    ...
    now(),
    'BAU (CANDO-8050) to update Order''s Status back to ''Cancelled'' after it was placed on ''Credit Check''.'
);
