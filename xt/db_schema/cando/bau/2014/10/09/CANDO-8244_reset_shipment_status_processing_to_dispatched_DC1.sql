...
-- CANDO-8244: Reset Shipment Status from Processing to Dispatched
...
FROM    shipment WHERE id = 5895801
...
SELECT  id,
        ...
        ( SELECT id FROM operator WHERE name='Application' ),
        'BAU (CANDO-8244): Have Reset Shipment Status from ''Processing'' to ''Dispatched'''
FROM    shipment
WHERE   id = 5895801
AND     shipment_status_id = (
    SELECT id FROM shipment_status WHERE status='Processing'
