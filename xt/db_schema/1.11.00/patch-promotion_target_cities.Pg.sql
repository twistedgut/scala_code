-- psql -d xtracker -f promotions.sql -f patch-promotion_target_cities.Pg.sql
BEGIN;
    ...
    DELETE  FROM promotion.target_city
    WHERE   id != 1;


    -- other items that the spoec says need to be at the top of the list
    INSERT INTO promotion.target_city (id, name, timezone, display_order)
    VALUES
