...
BEGIN;
    ...
    ALTER TABLE orders ALTER COLUMN date SET DATA TYPE TIMESTAMP WITH TIME ZONE USING date AT TIME ZONE 'Asia/Hong_Kong';

    ALTER TABLE shipment ALTER COLUMN date SET DATA TYPE TIMESTAMP WITH TIME ZONE USING date AT TIME ZONE 'Asia/Hong_Kong';
    ALTER TABLE shipment ALTER COLUMN sla_cutoff SET DATA TYPE TIMESTAMP WITH TIME ZONE USING sla_cutoff AT TIME ZONE 'Asia/Hong_Kong';
