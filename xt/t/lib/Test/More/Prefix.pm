...
Test::More::Prefix - prefix test output

=head1 DESCRIPTION

Inject a prefix in to Test::Builder's output. Useful for providing context in
noisy tests
...
package Test::More::Prefix::ModifierRole; ## no critic(ProhibitMultiplePackages)
...
package Test::Builder; ## no critic(ProhibitMultiplePackages)
use Moose;
