...
use Test::XT::Rules::Definitions;
use Test::XT::Rules::Hash;
use Test::XT::Rules::Situation;
use Test::XT::Rules::Type;
...
sub lookup {
    ...
    my $rule = $Test::XT::Rules::Definitions::rules{ $rule_name };
...
sub execute {
    ...
    # non-existant key.
    my $situation = eval { Test::XT::Rules::Situation->generate({
    ...
    # The right type?
    my $qualified_constraint_name = 'Test::XT::Rules::Type::' .
...
sub environment {
    ...
    unless ($schema) {
        $schema = bless {}, 'Test::XT::Rules::Solve::FakeSchema';
    }
...
sub configuration_rules {
    ...
    my %return_hash;
    tie %return_hash, 'Test::XT::Rules::Hash', \%results;

    return \%return_hash;

}

sub Test::XT::Rules::Solve::FakeSchema::resultset {
