package Test::XT::Fixture::PutawayPrep::Container;
...
Test::XT::Fixture::PutawayPrep::Container - Fixture for a PuwawayPrepContainer and its contents

=head1 DESCRIPTION

Set up test data for testing PutawayPrep-related features.
