...
use Test::XTracker::RunCondition dc => 'DC3';
my $schema = Test::XTracker::Data->get_schema;

my $channel_id  = $CHANNEL__NAP_APAC;
...
#        shipping_charge_id => non_prem_charge[0] $prem_postcode->shipping_charge_id,
    },
    pids => $pids,
    attrs => [
        { price => 100.00 },
...
Tests that the carrier automation field can't be seen when in DC1
...
sub test_carrier_automation_field {
    ...
    note "TESTING that carrier automation section doesn't appear in DC3";

    # get non-premier shipping charges
    my $premier_charge;
    my @non_prem_charge;
